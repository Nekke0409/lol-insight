...
data class BenchmarkReplenishmentAttemptDiagnostic(
    ...
    constructor(attempt: BenchmarkReplenishmentAttempt) : this(
        ...
        discoveredPlayers = attempt.seedResult.discoveredPlayers,
        candidatePlayers = attempt.seedResult.candidatePlayers,
        selectedPlayers = attempt.seedResult.uniquePlayers,
        selectedZeroValidSamplePlayers = attempt.seedResult.selectedZeroValidSamplePlayers,
        selectedExistingValidSamplePlayers = attempt.seedResult.selectedExistingValidSamplePlayers,
